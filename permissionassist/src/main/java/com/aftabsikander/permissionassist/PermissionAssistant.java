...
public class PermissionAssistant {
    ...
    public static void requestPermissions(@NonNull Activity activity,
        ...
        requestPermissions(activity, rationale, android.R.string.ok,
    ...
    public static void requestPermissions(@NonNull Activity activity,
        ...
        if (shouldShowRationale(activity, perms)) {
            showRationaleDialogFragment(
                    activity.getFragmentManager(), rationale, positiveButton,
    ...
    public static void requestPermissions(@NonNull Fragment fragment,
                                          ...
                                          int requestCode,
                                          @NonNull String... perms) {
        requestPermissions(fragment, rationale, android.R.string.ok,
                android.R.string.cancel, requestCode, perms);
    }
    ...
    public static void requestPermissions(@NonNull Fragment fragment,
        ...
        if (shouldShowRationale(fragment, perms)) {
            RationaleDialogFragmentCompat.newInstance(positiveButton, negativeButton, rationale,
                    requestCode, perms).show(fragment.getChildFragmentManager(), DIALOG_TAG);
        } else {
    ...
    public static void requestPermissions(@NonNull android.app.Fragment fragment,
        ...
        if (shouldShowRationale(fragment, perms)) {
            showRationaleDialogFragment(
                    fragment.getChildFragmentManager(), rationale, positiveButton,
                    negativeButton, requestCode, perms);
        } else {
            fragment.requestPermissions(perms, requestCode);
        }
