...
import com.aftabsikander.permissionassist.R;
...
public final class AppSettingsDialog implements Parcelable, DialogInterface.OnClickListener {

    /***
     * request code to track {@link AppSettingsDialog}
     */
    public static final int DEFAULT_SETTINGS_REQ_CODE = 16061;
    /***
     * Bundle Constant value to track {@link AppSettingsDialog}
     */
    public static final String EXTRA_APP_SETTINGS = "extra_app_settings";

    /****
     * Create Parcelable instance for {@link AppSettingsDialog}
     */
    ...
    public static class Builder {
         ...
         *
         * @param title set the title for dialog.
         * @return {@link Builder} instances.
         */
         ...
         *
         * @param rationale set the rationale message for dialog.
         * @return {@link Builder} instances.
         */
         ...
         * @param negativeListener set negative click listener.
         * @return {@link Builder} instances.
         ...
         * com.aftabsikander.permissionassist.PermissionAssistant#hasPermissions(Context, String...)}
         * in {@link Activity#onActivityResult(int, int, Intent)}. If you still don't have the right
         ...
         *
         * @param requestCode request code to track Setting Screen for result.
         * @return {@link Builder} instances.
         */
         ...
         *
         * @return {@link AppSettingsDialog} instances.
         */
